...
chord_blade_MMA1 = 0.2 #inputs 7
cd_blade_MMA1 = 0.01 #inputs 8
omega_MMA1 = 100 #inputs 9
...
r_MMA3 = 0.21*2 #inputs 6 x2 compared to research https://www.researchgate.net/publication/351569758_Conceptual_design_of_a_fixed_wing_vertical_take-off_and_landing_unmanned_aerial_vehicle
wing_eff_prop_on_MMA3 = 0.7 #inputs 7 
V_stall_MMA3 = np.sqrt(2*W/(1.225*S_wing_MMA3*CLmax_MMA3))#inputs 8
A_prop_MMA3 = (r_MMA3)**2*np.pi #inputs 9
N_blades_MMA3 = N_blades_MMA1 #inputs 10
chord_blade_MMA3 = chord_blade_MMA1 #inputs 11
...
A_prop_MMA4 = (r_MMA3)**2*np.pi #inputs 10
N_blades_MMA4 = N_blades_MMA1 #inputs 11
chord_blade_MMA4 = chord_blade_MMA1 #inputs 12
cd_blade_MMA4 = cd_blade_MMA1 #inputs 13
omega_MMA4 = omega_MMA1 #inputs 14


inputs_list_original = [[W,eta,CD0_MMA1,S_parasite_MMA1,r_MMA1,A_prop_MMA1,N_blades_MMA1,chord_blade_MMA1,cd_blade_MMA1,omega_MMA1],
                        [W,eta,CD0_MMA2,Stop_MMA2,Sfront_MMA2,r_MMA2,A_prop_MMA2,N_blades_MMA2,chord_blade_MMA2,cd_blade_MMA2,omega_MMA2],
                        [W,eta,CD0_MMA3,piAe_MMA3,S_wing_MMA3, CLmax_MMA3,r_MMA3,wing_eff_prop_on_MMA3,V_stall_MMA3,A_prop_MMA3,N_blades_MMA3,chord_blade_MMA3,cd_blade_MMA3,omega_MMA3],
                        [W,eta,CD0_MMA4,piAe_MMA4,S_MMA4,CLmax_MMA4,r_MMA4,wing_eff_prop_on_MMA4,prop_efficiency_MMA4,V_stall_MMA4,A_prop_MMA4,N_blades_MMA4,chord_blade_MMA4,cd_blade_MMA4,omega_MMA4]]
