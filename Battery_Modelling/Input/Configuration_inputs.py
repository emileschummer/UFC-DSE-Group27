...
diameter_MMA1 = 1.041 #https://dspace-erf.nlr.nl/server/api/core/bitstreams/9dc27553-90f0-4209-b744-0adee5c75f27/content 
totalA_MMA2 = (diameter_MMA1/2)**2*np.pi #inputs 5
...
S_MMA3 = 0.5*2 #inputs 4 m^2 x2 compared to research (cuz reearch is 10kg, we go 20)
...
r_MMA3 = 0.21*2 #inputs 6x2 compared to research https://www.researchgate.net/publication/351569758_Conceptual_design_of_a_fixed_wing_vertical_take-off_and_landing_unmanned_aerial_vehicle
