...
@patch("Midterm_Battery_Modelling.Modelling.races.sva.make_race_dictionnary")
@patch("Midterm_Battery_Modelling.Modelling.races.plt.savefig")
@patch("Midterm_Battery_Modelling.Modelling.races.plt.show")
