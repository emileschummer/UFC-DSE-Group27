...
from Midterm_Battery_Modelling.Modelling.races import plot_race_results, flat_race
import pandas as pd
...
@patch("Midterm_Battery_Modelling.Modelling.races.calculate_power_UFC_MMA_1", return_value=10)
@patch("Midterm_Battery_Modelling.Modelling.races.calculate_power_UFC_MMA_2", return_value=20)
@patch("Midterm_Battery_Modelling.Modelling.races.calculate_power_UFC_MMA_3", return_value=30)
@patch("Midterm_Battery_Modelling.Modelling.races.calculate_power_UFC_MMA_4", return_value=40)
